...
<div class="container">
    ...
    <div>
        <ul>
            <li><a href="?locale=en&searchName=${searchName}">English</a></li>
            <li><a href="?locale=ru&searchName=${searchName}">Русский</a></li>
        </ul>
    </div>
    <form action="${pageContext.request.contextPath}/items/search">
        <div class="input-group">
            ...
            <input class="form-control" type="text" id="searchName" name="searchName" value="${searchName}">
            <div class="input-group-append">
                <button class="btn btn-outline-success"><spring:message code="searchPage.btnSearch"/></button>
            </div>
        </div>
    </form>
    <h3 class="h3"><spring:message code="searchPage.title"/></h3>
                    ...
                    <c:choose>
                        <c:when test="${pages.number eq page}">
                            <li class="page-item active">
                                <a href="?page=${page}&size=${pages.size}&searchName=${searchName}"
